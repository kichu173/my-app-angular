...
@NgModule({
  ...
  imports: [//*imports needed because components declared here are dependent on these modules, imports are module specific declared components.
    RouterModule, // to avoid router-outlet problems in recipes component.
  ...
  //1.To use recipes module in app module we use exports,so that we can not just use them in recipes module but in any module that imports the recipe module that could be the app module in imports:[].
  //     RecipesComponent,
  //     RecipeListComponent,
  //     RecipeDetailComponent,
  //     RecipeItemComponent,
